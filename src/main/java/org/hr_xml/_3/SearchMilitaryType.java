...
@XmlType(name = "SearchMilitaryType", propOrder = {
    "screeningSubjectID",
    "militaryHistory",
    "additionalItem",
    "userArea"
})
public class SearchMilitaryType {
