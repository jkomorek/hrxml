 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.openapplications.org/oagis/9}EFTDetailBaseType">
 *       &lt;sequence>
 *         &lt;element ref="{http://www.openapplications.org/oagis/9}ChequeNumber" minOccurs="0"/>
...
@XmlType(name = "ChequeType", propOrder = {
    "chequeNumber",
    "userArea"
})
public class ChequeType
    extends EFTDetailBaseType
{

    @XmlElement(name = "ChequeNumber")
    protected IdentifierType chequeNumber;
     ...
     *     
     */
    public IdentifierType getChequeNumber() {
        return chequeNumber;
    }
     ...
     *     
     */
    public void setChequeNumber(IdentifierType value) {
