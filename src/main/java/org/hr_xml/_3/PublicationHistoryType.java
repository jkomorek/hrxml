 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.hr-xml.org/3}PublicationHistoryID" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.hr-xml.org/3}Publication" maxOccurs="unbounded" minOccurs="0"/>
...
public class PublicationHistoryType {
    ...
    @XmlElement(name = "PublicationHistoryID")
    protected List<IdentifierType> publicationHistoryID;
     ...
     * This is why there is not a <CODE>set</CODE> method for the publicationHistoryID property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPublicationHistoryID().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IdentifierType> getPublicationHistoryID() {
        if (publicationHistoryID == null) {
            publicationHistoryID = new ArrayList<IdentifierType>();
        }
        return this.publicationHistoryID;
    }
