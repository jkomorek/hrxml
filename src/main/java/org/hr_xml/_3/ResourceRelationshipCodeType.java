...
/**
 * <p>Java class for ResourceRelationshipCodeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ResourceRelationshipCodeType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.hr-xml.org/3>ResourceRelationshipCodeContentType">
...
@XmlType(name = "ResourceRelationshipCodeType", propOrder = {
    "value"
})
public class ResourceRelationshipCodeType {
    ...
    /**
     * A code classifying a resource's employment relationship with repect to an associated organization within an assignment. In the vast majority of cases, a resource can be classified as either an employee (a "direct hire") or a vendor's employee. The "Vendor Employee" concept encompasses those self employed and 
     * those sourced through a staffing or leasing company. 
     * 
     * @return
     *     possible object is
     *     {@link String }
