...
/**
 * A code classifying the scope of the contract - For example, whether the contract applies to services nationwide, worldwide, etc.
 * 
 * <p>Java class for ContractScopeCodeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ContractScopeCodeType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.hr-xml.org/3>ContractScopeCodeContentType">
...
@XmlType(name = "ContractScopeCodeType", propOrder = {
    "value"
})
public class ContractScopeCodeType {
