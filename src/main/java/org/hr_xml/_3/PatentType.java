 ...
 * 				
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;ccts:DictionaryEntryName xmlns:ccts="urn:un:unece:uncefact:documentation:1.1" xmlns="http://www.hr-xml.org/3" xmlns:oa="http://www.openapplications.org/oagis/9" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;Patent. Details&lt;/ccts:DictionaryEntryName&gt;
 * </pre>
 * 
 * 				
 * <pre>
 * &lt;?xml version="1.0" encoding="UTF-8"?&gt;&lt;ccts:DefinitionText xmlns:ccts="urn:un:unece:uncefact:documentation:1.1" xmlns="http://www.hr-xml.org/3" xmlns:oa="http://www.openapplications.org/oagis/9" xmlns:xsd="http://www.w3.org/2001/XMLSchema"&gt;A licence from a government conferring for a set period the sole right to make, use, or sell some process or invention.&lt;/ccts:DefinitionText&gt;
 * </pre>
 * 
 * 			
 * 
 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.hr-xml.org/3}PatentID" minOccurs="0"/>
 *         &lt;element ref="{http://www.hr-xml.org/3}PatentTitle" minOccurs="0"/>
 *         &lt;element ref="{http://www.openapplications.org/oagis/9}Description" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.hr-xml.org/3}InventorName" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.hr-xml.org/3}IssuingAuthority" minOccurs="0"/>
 *         &lt;element ref="{http://www.hr-xml.org/3}PatentStatus" maxOccurs="unbounded" minOccurs="0"/>
...
public class PatentType {
    ...
    @XmlElement(name = "PatentID")
    protected IdentifierType patentID;
    ...
    @XmlElement(name = "InventorName")
    protected List<TextType> inventorName;
    @XmlElement(name = "IssuingAuthority")
    protected IssuingAuthorityType issuingAuthority;
    @XmlElement(name = "PatentStatus")
    protected List<PatentStatusType> patentStatus;
     ...
     *     
     */
    public IdentifierType getPatentID() {
        return patentID;
    }
     ...
     *     
     */
    public void setPatentID(IdentifierType value) {
        this.patentID = value;
    }
    ...
    /**
     * The person or corporate body that applies for the patent and intends to make, use, or sell some process or invention.Gets the value of the inventorName property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     ...
     * 
     */
    public List<TextType> getInventorName() {
        if (inventorName == null) {
            inventorName = new ArrayList<TextType>();
        }
    ...
    /**
     * Gets the value of the patentStatus property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the patentStatus property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPatentStatus().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link PatentStatusType }
     * 
     * 
     */
    public List<PatentStatusType> getPatentStatus() {
        if (patentStatus == null) {
            patentStatus = new ArrayList<PatentStatusType>();
        }
