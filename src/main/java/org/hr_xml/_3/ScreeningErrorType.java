...
/**
 * Note: ConfirmBOD is generally used to report BOD and 
 * 			noun failures. In a few cases, such as in a ScreeningReport, it may also be
 * 			necessary to include error details among a partially fulfilled screening.
 * 
 * <p>Java class for ScreeningErrorType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ScreeningErrorType">
 *   &lt;complexContent>
...
@XmlType(name = "ScreeningErrorType", propOrder = {
    "id",
    "typeCode",
    "reasonCode",
    "description",
...
public class ScreeningErrorType {
