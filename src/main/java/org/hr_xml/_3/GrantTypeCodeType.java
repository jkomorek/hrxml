...
/**
 * A code classifying the type of Stock Option Grant.  A restricted stock option is a stock option for shares whereby upon exercise, the participant receives unvested shares and is restricted from transferring or selling the shares until the shares vest (usually according to a time-based vesting schedule).
 * 
 * <p>Java class for GrantTypeCodeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GrantTypeCodeType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.hr-xml.org/3>GrantTypeCodeContentType">
...
@XmlType(name = "GrantTypeCodeType", propOrder = {
    "value"
})
public class GrantTypeCodeType {
