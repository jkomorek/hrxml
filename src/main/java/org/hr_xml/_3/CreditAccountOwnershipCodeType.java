...
/**
 * A code classifying the ownership relation of the borrower(s) to the liability account (i.e. are they solely responsible, jointly responsible, a co-signer on the account, etc.) The exact code values vary from credit bureau to credit bureau.  Also referred to as an "ECOA Code" (Equal Credit Opportunity Act). 
 * 
 * <p>Java class for CreditAccountOwnershipCodeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CreditAccountOwnershipCodeType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.hr-xml.org/3>CreditAccountOwnershipCodeContentType">
...
@XmlType(name = "CreditAccountOwnershipCodeType", propOrder = {
    "value"
})
public class CreditAccountOwnershipCodeType {
