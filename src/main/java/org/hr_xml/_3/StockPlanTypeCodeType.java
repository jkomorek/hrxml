...
/**
 * A code classifying the type of stock plan. HR-XML's specifications are intended to support "Stock Option" and "Stock Purchase" plans. These values are enumerated, but this is an HR-XML open list so other plan types might be specified if supported by the HR-XML stock plan model.
 * 
 * <p>Java class for StockPlanTypeCodeType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="StockPlanTypeCodeType">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://www.hr-xml.org/3>StockPlanTypeContentType">
...
@XmlType(name = "StockPlanTypeCodeType", propOrder = {
    "value"
})
public class StockPlanTypeCodeType {
